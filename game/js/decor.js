...
export function initDecor(world, ui) {
  const dec = {
    ...
    myHome: {
      ...
      cosmetics: world.player.cosmetics || { hat: null, shirt: null, bottom: null, wings: null },
    ...
    try {
      ...
      if (v) {
        ...
        dec.myHome = {
          ...
          cosmetics: v.cosmetics || world.player.cosmetics || { hat: null, shirt: null, bottom: null, wings: null },
          avatar: { variant: world.player.variant, hair: world.player.hair || null, shirt: world.player.shirt || null },
        };
        ...
        // เหมือนกัน — ห้องมีเครื่องแต่งกายบันทึกไว้แต่ session นี้ยังไม่ได้ตั้ง (localStorage ถูกล้าง)
        if (v.cosmetics) world.player.cosmetics = v.cosmetics;
      }
    } catch {}

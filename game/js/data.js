...
export const NPCS = [
  ...
  { name: "พี่อ้อ", role: "CTO", variant: 3, home: [3, 22], roam: 1,
    lines: [
  ...
  { name: "พี่หว่า", role: "CCO", variant: 4, home: [11, 3], roam: 1,
    lines: [
  ...
  { name: "พี่แตน", role: "CDO", variant: 6, home: [19, 3], roam: 1,
    lines: [
  ...
  { name: "คุณ TT", role: "CFO", variant: 5, home: [25, 13], roam: 2,
    lines: [

...
// roomBox: [x0,y0,x1,y1] หน่วย tile (พิกัดต่อเนื่อง ไม่ใช่ index) — กรอบห้องจริงของแต่ละคน เดินสุ่ม
// จะไม่ออกนอกกรอบนี้เด็ดขาด (เผื่อร่นจากผนังจริงเล็กน้อยกันเดินชิดผนังเกินไป) ตัวเลขอ้างจาก
// interactionZones ใน scb_floor7_map_large3x.json (cco_office/cro_office/cdo_office/
// cfo_finance/cto_technology) — CEO ไม่มีห้องส่วนตัวในผัง เลยให้กรอบโซนเปิดรอบโต๊ะแทน
// บทพูดสุ่มจาก lines เมื่อผู้เล่นเข้าใกล้
export const NPCS = [
  { name: "พี่หนุ่ม", role: "CEO", variant: 2, home: [15, 8], roam: 2, roomBox: [12, 6.5, 19, 10.5],
    lines: [
  ...
  { name: "พี่อ้อ", role: "CTO", variant: 3, home: [3, 22], roam: 1, roomBox: [1.6, 21.6, 4.4, 24.4],
    lines: [
  ...
  { name: "พี่หว่า", role: "CCO", variant: 4, home: [11, 3], roam: 1, roomBox: [10.6, 2.6, 12.4, 5.4],
    lines: [
  ...
  { name: "คุณ Manis", role: "CRO", variant: 7, home: [15, 3], roam: 1, roomBox: [13.6, 2.6, 16.4, 5.4],
    lines: [
  ...
  { name: "พี่แตน", role: "CDO", variant: 6, home: [19, 3], roam: 1, roomBox: [17.6, 2.6, 21.4, 5.4],
    lines: [
  ...
  { name: "คุณ TT", role: "CFO", variant: 5, home: [25, 13], roam: 2, roomBox: [22.6, 11.6, 27.4, 15.4],
    lines: [

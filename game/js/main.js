...
import { PETS, PET_FRAME, PET_SRC_FRAME, petIconRow } from "./pets_data.js";
...
function drawPetIcon(canvas, petIndex) {
  ...
  const draw = () => cc.drawImage(petImg, 0, petIconRow(PETS[petIndex].id) * PET_SRC_FRAME, PET_SRC_FRAME, PET_SRC_FRAME, 0, 0, PET_FRAME, PET_FRAME);

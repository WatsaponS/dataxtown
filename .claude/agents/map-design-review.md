...
- NPC ผู้บริหาร 6 คนมี home เป็น tile grid 32 ใน `data.js` — ต้องยืนบน tile ที่เดินได้และอยู่ในโซนห้องตัวเอง
  (CEO เวที, CCO/CRO/CDO สามห้องแถวเหนือ, CTO ตะวันตกล่าง, CFO ตะวันออก)

#!/usr/bin/env python3
"""Regenerable build for dragon — produced by pixelpipe. Edit and rerun to iterate."""
import sys
sys.path.insert(0, 'C:\\Users\\Admin\\.codex\\skills\\pixel-art-studio/scripts')
from pixelstudio import Sprite

s = Sprite.from_png('C:\\Users\\Admin\\Desktop\\Project\\DataXTown\\pixel-art\\zodiac-pets-economy\\transparent\\dragon.png', scale='auto', strip_bg=False)

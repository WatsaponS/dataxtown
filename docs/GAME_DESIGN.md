...
- เก็บใน Firebase `homes/<uid>` = { name, spent, items:[{id,x,y}] } — x,y null = ยังไม่วาง;
  วาง/เก็บของด้วยการเลือกจาก inventory แล้วคลิกช่องในห้อง (วางทับ = สลับชิ้นเดิมเข้ากระเป๋า)

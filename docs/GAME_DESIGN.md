...
### 3.13 สัตว์เลี้ยง
- เลือกได้ 1 ใน **15 ชนิด** ที่หน้าสร้างตัวละคร (หมา แมว นก หนู งู กระต่าย เต่า เป็ด หมูจิ๋ว
  เพนกวิน กบ ไก่ เม่น จิ้งจอก มังกรจิ๋ว) หรือเลือก "ไม่มี" — sprite วาดจาก
  `assets/build_pets.py` → `pets.png` (15 แถว × 2 เฟรมเดิน หันซ้าย, flip ตอนเดินขวา)
...
- **เห็นสัตว์เลี้ยงของผู้เล่นคนอื่นด้วย**: ส่ง petId ไปกับ join payload (ทั้ง WebSocket และ
